        ...
        <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
            <thead class="bg-[#b1b1b1] text-white">
                <tr>
                    ...
                    <th class="py-3 px-6 text-left text-xs font-medium uppercase tracking-wider">Calve unica de producto </th>
                    <th class="py-3 px-6 text-left text-xs font-medium uppercase tracking-wider">Numero de producto</th>
                    <th class="py-3 px-6 text-left text-xs font-medium uppercase tracking-wider">Descripcion de producto</th>
            ...
            <tbody class="text-gray-700">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100 transition duration-200">
                    ...
                    <td class="py-4 px-6 whitespace-nowrap">{{ $inventario->clave_unica }}</td>
