...
@section('content')
    <h1 class="text-3xl font-medium">FACTURA</h1>
        ...
        <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
            <thead class="bg-[#b1b1b1] text-white">
                <tr>
                    ...
                    <th class="py-3 px-6 text-left text-xs font-medium uppercase tracking-wider">Numero de factura</th>
                    <th class="py-3 px-6 text-left text-xs font-medium uppercase tracking-wider">Cliente</th>
                    <th class="py-3 px-6 text-left text-xs font-medium uppercase tracking-wider">Fecha de emision</th>
                    <th class="py-3 px-6 text-left text-xs font-medium uppercase tracking-wider">Fecha de vencimiento</th>
            ...
            <tbody class="text-gray-700">
                @foreach ($facturacions as $facturacion)
                    <tr class="border-b border-gray-200 hover:bg-gray-100 transition duration-200">
                        <td class="py-4 px-6 whitespace-nowrap">{{ $facturacion->id }}</td>
                        <td class="py-4 px-6 whitespace-nowrap">{{ $facturacion->number_factura }}</td>
                        <td class="py-4 px-6 whitespace-nowrap">{{ $facturacion->cliente_id }}</td>
                        <td class="py-4 px-6 whitespace-nowrap">{{ $facturacion->fecha_emision }}</td>
                        <td class="py-4 px-6 whitespace-nowrap">{{ $facturacion->fecha_vencimiento }}</td>
